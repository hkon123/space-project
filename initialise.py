...
class initializing(object):
    ...
    def __init__(self):
        ...
        while self.select!=0:
            ...
            if self.select==6:
                os.system('cls' if os.name == 'nt' else 'clear')
                universe = str(raw_input("select universe "))
                os.system('cls' if os.name == 'nt' else 'clear')
                launches = int(raw_input("number of satelite Launches?(max3) "))
                os.system('cls' if os.name == 'nt' else 'clear')
                start1 = int(raw_input("startdate for 1st launch in years(if not applicaple make 0) "))
                os.system('cls' if os.name == 'nt' else 'clear')
                start2 = int(raw_input("startdate for 2nd launch in years(if not applicaple make 0) "))
                os.system('cls' if os.name == 'nt' else 'clear')
                start3 = int(raw_input("startdate for 3rd launch in years(if not applicaple make 0) "))
                os.system('cls' if os.name == 'nt' else 'clear')
                ship1 = str(raw_input("shipfile for first launch? (if not aplicable make 0)"))
                os.system('cls' if os.name == 'nt' else 'clear')
                ship2 = str(raw_input("shipfile for second launch? (if not aplicable make 0)"))
                os.system('cls' if os.name == 'nt' else 'clear')
                ship3 = str(raw_input("shipfile for third launch? (if not aplicable make 0)"))
                os.system('cls' if os.name == 'nt' else 'clear')
